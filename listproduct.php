        ...
        <div class="col-12 col-sm-3 col-md-3" style="margin-bottom: 20px;">
            <div class="card" style="width: 100%;">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text"> <?php echo 'ราคา ' . number_format($rsprd["p_price"], 2) . ' บาท';?> </p>
                    
                    <a href="detail.php?p_id=<?php echo $rsprd['p_id']; ?>" class="btn btn-info" role="button">รายละเอียด</a>
